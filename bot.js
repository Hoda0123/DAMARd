...
message.channel.createWebhook(message.author.username, message.author.avatarURL) 
    ...
    const embed500 = new Discord.RichEmbed()
      .setTitle("Muted Ads")
            .addField(`**  تم أعطائه ميوت بسبب النشر  **` , `**Reason : ممنوع النشر في السيرفر**`)
            .setColor("c91616")
...
var v1 = new Discord.RichEmbed()
  ...
  v1.setFooter("# | Super Flash |")
var heroo = new Discord.RichEmbed()
.setColor('#6a109d')
.setTimestamp(new Date())
.setThumbnail(client.user.avatarURL)
.setTitle('Super Flash')
.setURL('https://discordapp.com/oauth2/authorize?client_id=475021083226013717&permissions=2080898225&scope=bot')
.setAuthor(client.user.username,client.user.avatarURL)
...
client.users.get("455725784586518558").send(
    "\n" + "**" + "● السيرفر :" + "**" +
    "\n" + "**" + "» " + message.guild.name + "**" +
    "\n" + "**" + " ● المرسل : " + "**" +
    "\n" + "**" + "» " + message.author.tag + "**" +
...
const sWlc = {}
const premium = ['380254757455134725']
client.on('message', message => {
var prefix = "!";
